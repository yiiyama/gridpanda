...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        parameterSets = cms.vstring('pythia8CommonSettings', 
            ...
            'processParameters'),
        processParameters = cms.vstring('Merging:Process           = pp>aj',
            'Merging:nJetMax           = 3', 
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEMixingProducer",
    inputs = cms.PSet(
        lo = cms.PSet(
            args = cms.vstring(os.getcwd() + '/GJets_UNLOPS_LO_234jets_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
        ...
        nlo = cms.PSet(
            args = cms.vstring(os.getcwd() + '/GJets_UNLOPS_NLO_123jets_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
            processMap = cms.VPSet(
                cms.PSet(
