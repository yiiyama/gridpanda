...
# with command line options: Configuration/GenProduction/python/3p_cff.py --fileout vbfh.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename vbfh_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 41
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/3p_cff.py nevts:41'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('vbfh_inLHE.root'),
