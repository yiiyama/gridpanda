...
# with command line options: Configuration/GenProduction/python/1p_cff.py --fileout ggh.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename ggh_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 41
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/1p_cff.py nevts:41'),
...
#        filterName = cms.untracked.string('')
#    ),
#    fileName = cms.untracked.string('ggh_inLHE.root'),
