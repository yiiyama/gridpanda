...
# with command line options: Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-03009-fragment.py --fileout file:HIG-RunIIFall17wmLHEGS-03009.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename HIG-RunIIFall17wmLHEGS-03009_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1553723658%100) -n 36
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-03009-fragment.py nevts:36'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall17wmLHEGS-03009_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring(os.getcwd() + '/HZJ_slc6_amd64_gcc700_CMSSW_9_3_0_HZJ_HanythingJ_NNPDF31_13TeV_M200_ZtoLL.tgz'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1553723658%100)
