...
# with command line options: step1 --fileout miniaodsim.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --era Run2_2016 --python_filename miniaodsim.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1
