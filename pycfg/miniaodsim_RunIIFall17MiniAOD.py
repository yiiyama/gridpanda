...
# with command line options: step1 --fileout file:HIG-RunIIFall17MiniAOD-00463.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v10 --step PAT --nThreads 8 --era Run2_2017 --python_filename HIG-RunIIFall17MiniAOD-00463_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 4800
